...
def model_init(GPU_rate):
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument('--checkpoint', type=str,
                        default='/home/fyyc/codes/deecamp/MinistAiCompose/lxd/paraphraser/model/model-335000',  ## /data/Lxd/Lxd_paraphraser/logs/train-20190730-074926/model-335000'
                        help='Checkpoint path')
    args = parser.parse_args()
    paraphraser = Paraphraser(args.checkpoint,GPU_rate)
    return paraphraser
...
if __name__ == '__main__':
    paraphraser = model_init(0.5)  ## restore model
    source_sentence = 'I like apple'
    print( inference(paraphraser,source_sentence))
